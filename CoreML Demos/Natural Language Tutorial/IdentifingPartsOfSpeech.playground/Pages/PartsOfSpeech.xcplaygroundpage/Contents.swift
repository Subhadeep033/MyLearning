...
let tagger = NLTagger(tagSchemes: [.lexicalClass, .language, .script, .sentimentScore])
tagger.string = str

tagger.enumerateTags(in: str.startIndex..<str.endIndex, unit: .word, scheme: NLTagScheme.lexicalClass, options:[.omitPunctuation, .omitWhitespace]) { (tag, range) -> Bool in
